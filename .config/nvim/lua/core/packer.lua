...
return require('packer').startup(function(use)
  -- This section is for text manip related extension
  ...
  use 'levouh/tint.nvim'                -- this is for dimming inactive window
  use 'folke/twilight.nvim'             -- this is for dimming inactive part of code
  ...
  use 'folke/zen-mode.nvim'             -- this is for zen mode
